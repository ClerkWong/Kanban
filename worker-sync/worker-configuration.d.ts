/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-sync/worker-configuration.d.ts -c worker-sync/wrangler.jsonc` (hash: 361235ff3aa153af18f1a9427a703fac)
